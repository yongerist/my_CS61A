...
def swine_align(player_score, opponent_score):
    ...
    if player_score > opponent_score:
        ...
        myGcd = Gcd(opponent_score, player_score)
    return True if myGcd >= 10 else False
    # END PROBLEM 4a
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        return announce_highest(who, score1 if who else score0, new_high)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    goal = 1
    outcome = make_averaged(roll_dice, trials_count)
    biggest = 0
    for i in range(1, 11):
        temp = outcome(i, dice)
        # print("DEBUG: ", temp)
